...
const int CALIBRATION_FORWARD_RIGHT = 242;
...
void move(float amount, const char *direction) {
  // move() is the closed-loop motion primitive.
  // It converts a physical request to encoder ticks, executes motion,
  // tracks progress from both wheels, applies turn slowdown near the target,
  // and always exits on target or timeout.
  //
  // Input units:
